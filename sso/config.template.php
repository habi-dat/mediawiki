...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://$HABIDAT_MEDIAWIKI_SUBDOMAIN.$HABIDAT_DOMAIN/simplesaml/',
     ...
     */
    'auth.adminpassword' => '$MEDIAWIKI_ADMIN_PASSWORD',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'sqlite:/var/www/html/simplesaml_sqlitedatabase.sq3',
